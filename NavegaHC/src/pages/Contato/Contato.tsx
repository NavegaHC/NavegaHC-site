      ...
      <div className="bg-gray-50 shadow-lg rounded-lg p-6 w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-6 justify-center mt-6">
            <a 
              href="https://www.instagram.com/redelucymontoro/" 
              target="_blank" 
            ...
            >
              <img 
                ...
                alt="Instagram" 
                className="h-12 w-12 hover:scale-110 transition-transform duration-200 group-hover:drop-shadow-lg" 
              />
            </a>
            <a 
              href="https://web.facebook.com/redelucymontoro?_rdc=1&_rdr#" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group"
            >
